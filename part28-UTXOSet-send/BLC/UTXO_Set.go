...
// GetAbleUTXO 返回本次交易所用交易及其对应的金额
func (utxoSet *UTXOSet) GetAbleUTXO(from string, amount int64, txs []*Transaction) (int64, map[string][]int) {
...
// FindUnPackageSpendableUTXOS 返回要凑多少钱，对应TXOutput的TX的Hash和index
...
func (utxoSet *UTXOSet) Update() {
	// 最新的Block
	block := utxoSet.Blockchain.GetBlock(utxoSet.Blockchain.Tip)
	// utxoTable
	var ins []*TXInput
